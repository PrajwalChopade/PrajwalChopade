...
* 📧 **Email:** [prajwalchopade2005@gmail.com](mailto:prajwalchopade2005@gmail.com)
...
`Transformers` • `LangChain` • `LlamaIndex` • `HuggingFace` • `FAISS` • `Pinecone` • `ChromaDB` • `Ollama` 

### **Machine Learning & Data Science**

`sklearn` • `TensorFlow` • `OpenCV` • `NLTK` • `pandas` • `NumPy` • `Matplotlib`
